...
command! -nargs=0 CompileAndRun call TermWrapper(printf('g++ -std=c++17 -O2 %s && ./a.out', expand('%')))
command! -nargs=1 CompileAndRunWithFile call TermWrapper(printf('g++ -std=c++17 -O2 %s && ./a.out < %s', expand('%'), <args>))
"autocmd FileType cpp nnoremap <F5> :CompileAndRun<CR>
"autocmd FileType cpp nnoremap <F6> :CompileAndRunWithFile "input.txt"<CR>
autocmd FileType cpp nnoremap <F5> :w<CR>:!g++ -std=c++11 -o a.exe main.cpp<CR>
"autocmd FileType cpp nnoremap <F5> :w<CR>:!g++ -std=c++11 -o %:r % && konsole -e bash -c ./crunch<CR><CR>
autocmd FileType cpp nnoremap <F6> :w<CR>:!g++ -std=c++11 -o %:r % && konsole -e bash -c ./crunch_file<CR><CR>
